...
|<tt>multiline_regex_after</tt>|String|If a line maches this regular expression then it will be merged with the next line. The value must be a valid Python regex string.|<tt></tt>|
|<tt>multiline_regex_before</tt>|String|If a line maches this regular expression then it will be merged with the previous line. The value must be a valid Python regex string.|<tt></tt>|
